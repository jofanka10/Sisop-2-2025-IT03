...
// void download_and_unzip() {
//     printf("Mengunduh file dari Google Drive...\n");
//     char *wget_args[] = {"wget", "-O", "starterkit.zip", "https://drive.usercontent.google.com/download?id=1_5GxIGfQr3mNKuavJbte_AoRkEQLXSKS&confirm=t", NULL};
//     run_process(wget_args);
